/**
 * @author Kenta Xu with help from Alvin Li in Office Hours
 */
...
void lru_stack_set_mru(lru_stack_t* stack, int n) {
    ...
    ////////////////////////////////////////////////////////////////////
        ...
        for(int i = 0; i < stack->size; i++) {
            if(stack->priorityBits[i] > stack->priorityBits[n] && i != n) {
            	stack->priorityBits[i]--;
			}
        }

    stack->priorityBits[n] = (stack->size) - 1;
    ////////////////////////////////////////////////////////////////////
    //  End of your code
    ////////////////////////////////////////////////////////////////////
}
